# 🧠 Power BI
# 📊 Estrutura do README
1. **Medidas DAX** – Cálculos e KPIs principais  
2. **Colunas Calculadas** – Regras de negócio aplicadas diretamente no modelo  
3. **Colunas Power Query** – Pré-processamento e enriquecimento dos dados  
4. **Script Python** – Código responsável por carregar o modelo de machine learning no Power BI


=== INÍCIO DAS MEDIDAS DAX ===
...
====colunas adicionadas direto na power query ====
...
=====script em python que rodou direto na power query para trazer a ml para o power bi ====
